        ...
        <div class="col-4">
            ...
            <form class="mt-4" method="GET" action="">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="search" name="search" autocomplete="off" placeholder="Search" value="<?=$search?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="row" style="padding: 0 15px;">
                        <input class="form-control col-6" id="min_price" name="min_price" placeholder="to" autocomplete="off" value="<?=$from?>" >
                        <input class="form-control col-6" id="max_price" name="max_price" placeholder="From"  autocomplete="off" value="<?=$to?>">
                    </div>
                </div>
                <div class="form-group">
                    <div>
